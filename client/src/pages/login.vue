  ...
  <v-row class="w-100 fill-height d-flex align-center justify-center m-auto">
    <v-col cols="12" sm="6" md="4" class="ml-6 pa-10 border-lg">
      <div class="w-100 h-50 rounded-lg d-flex flex-column justify-center align-center">
        <h1 class="mb-4 w-100 rounded-lg border-lg text-center border bg-cyan text-white text-capitalize">Login
        </h1>
        <p class="mb-5">Login with your email, password</p>
        <div class=" w-100">
        ...
        <v-btn @click="register" class="text-white" width="200" min-height="40" color="cyan">Login</v-btn>
